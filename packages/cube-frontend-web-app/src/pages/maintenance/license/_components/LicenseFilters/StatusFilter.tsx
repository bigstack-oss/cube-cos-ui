...
export type LicenseStatus = 'valid' | 'unlicensed' | 'expired'
...
export type StatusFilterProps = {
  ...
  handleLicenseStatusesSelect: (statuses: LicenseStatus[]) => void
...
export const StatusFilter = (props: StatusFilterProps) => {
  ...
  const handleLicenseStatusClick = (licenseStatus: LicenseStatus) => {
